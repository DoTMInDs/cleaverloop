...
class SubscriptionPlan(models.Model):
    ...
    max_voice_profiles = models.PositiveIntegerField(default=3, help_text="0 for unlimited")
    voice_generation_credit_cost = models.PositiveIntegerField(default=15, help_text="Credits per speech generation")
    voice_clone_credit_cost = models.PositiveIntegerField(default=50, help_text="Credits per voice clone")
    can_clone_voices = models.BooleanField(default=True, help_text="Can create custom neural voice clones")
