...
class ProjectAuthorizationTests(TestCase):
    def setUp(self):
        self.user_a = User.objects.create_user(email="alice@cleverloop.ai", username="alice", password="password123")
        self.user_b = User.objects.create_user(email="bob@cleverloop.ai", username="bob", password="password123")
    ...
    def test_user_cannot_access_other_users_project(self):
        ...
        self.client.login(email="bob@cleverloop.ai", password="password123")
